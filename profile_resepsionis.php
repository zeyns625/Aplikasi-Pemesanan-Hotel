...
if (!isset($_SESSION['username'])) {
    header("Location: login_rsp.php"); // Redirect ke halaman login jika belum login
    exit();
}
...
<body class="bg-gray-100">
    <div class="flex flex-col md:flex-row">
        ...
        <div class="w-full md:w-3/4 p-8">
            ...
            <div class="mt-10">
                <?php if ($userData['role'] === 'resepsionis'): ?>
                    <h2 class="text-xl font-semibold">Resepsionis Dashboard</h2>
