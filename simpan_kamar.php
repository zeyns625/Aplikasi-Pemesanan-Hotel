...
if (isset($_POST["proses"])) {
    ...
    if (isset($_FILES["gambar"]["name"])) {
        ...
        if (!in_array($imageExtension, $validImageExtension)) {
            ...
            $query = "INSERT INTO kamar (jenis_kamar, harga_kamar, jumlah_kasur, gambar_kamar) VALUES ('$jenis_kamar', '$harga_kamar', '$jumlah', '$newImageName')";
            
            if (mysqli_query($koneksi, $query)) {
                echo "
                <script>
                    alert('Successfully Added');
                    document.location.href = 'dash_admin.php';
                </script>
                ";
            } else {
                echo "
