    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div class="w-full md:w-3/4 p-4 md:p-8">
            <div class="bg-gray-300 p-4 rounded-md mb-8">
                <h2 class="text-xl font-semibold">Update Data Kamar</h2>
            </div>
            <form action="update_kamar.php" method="post" autocomplete="off" enctype="multipart/form-data">
            <?php
            $id_kamar = $_GET['id'];
            include "koneksi.php";
            ...
            ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="jenis_kamar" class="w-full border-2 border-blue-500 rounded-full p-2"id="exampleInputEmail1"  value="<?php echo $data['jenis_kamar']; ?>" placeholder="Masukan Jenis Kamar">
                </div>

                <div class="mb-4">
                    <label class="block text-gray-700 mb-2">Harga Kamar</label>
                    <input type="text" name="harga_kamar" class="w-full border-2 border-blue-500 rounded-full p-2" id="exampleInputPassword1" value="<?php echo $data['harga_kamar']; ?>" placeholder="Masukan Harga Kamar">
                </div>

                <div class="mb-4">
                    <label class="block text-gray-700 mb-2">Jumlah  Kasur</label>
                    <input type="text" name="jumlah" class="w-full border-2 border-blue-500 rounded-full p-2" id="exampleInputPassword1"  value="<?php echo $data['jumlah_kasur']; ?>" placeholder="Masukan Jumlah Kasur">
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 mb-2">Ketersediaan</label>
                    <input type="text" name="ketersediaan" class="w-full border-2 border-blue-500 rounded-full p-2" id="exampleInputPassword1"  value="<?php echo $data['ketersediaan']; ?>" placeholder="Masukan Jumlah Ketersediaan">
                </div>
                ...
                <div class="custom-file">
                      <img src="pictures/<?php echo $data["gambar_kamar"]; ?>" width=200 title="<?php echo $data['gambar_kamar']; ?>"></td>
                      </div>
            </div>
