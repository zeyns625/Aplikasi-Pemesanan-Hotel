    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div class="w-full md:w-3/4 p-4 md:p-8">
            <div class="bg-gray-300 p-4 rounded-md mb-8">
                <h2 class="text-xl font-semibold">Tambah Data Fasilitas</h2>
            </div>

            <form action="simpan_fasilitas.php" method="post" autocomplete="off" enctype="multipart/form-data">
                <div class="mb-4">
                    <label class="block text-gray-700 mb-2">Fasilitas</label>
                    <input type="text" name="fasilitas" class="w-full border-2 border-blue-500 rounded-full p-2"id="exampleInputEmail1" placeholder="Masukan Nama Fasilitas">
                </div>
